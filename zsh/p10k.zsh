# Generated by Powerlevel10k configuration wizard on 2021-09-03 at 10:44 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # status
    # vcs                  # exit code of the last command
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%15F├─' #%244F
  ...
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%15F▶'
